...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g13.jpg" class="imh-fluid pb-3 mx-3" >
    </div>

    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g11.jpg" class="imh-fluid pb-3 mx-3 ">
    </div>

    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g3.jpg" class="imh-fluid pb-3 mx-3">
    </div>

    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g4.jpg" class="imh-fluid pb-3 mx-3">
    </div>

    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g5.jpg" class="imh-fluid pb-3 mx-3">
    </div>

    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g6.jpg" class="imh-fluid pb-3 mx-3">
    </div>

    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g7.jpg" class="imh-fluid pb-3 mx-3">
    </div>

    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g8.jpg" class="imh-fluid pb-3 mx-3">
    </div>


    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g9.jpg" class="imh-fluid pb-3 mx-3">
    </div>


    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g10.jpg" class="imh-fluid pb-3 mx-3">
    </div>
    ...
    <div class="col-lg-4 col-md-4 col-12">
        <img src="image/g12.jpg" class="imh-fluid pb-3 mx-3">
    </div>
